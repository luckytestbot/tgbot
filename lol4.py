...
# Sprawdzanie liczby tokenów dev'a
...
async def listen_for_tokens():
    ...
    print("Nawiązywanie połączenia z WebSocket...")

    try:
        async with websockets.connect(uri) as websocket:
            print("Połączono z PumpPortal. Nasłuchiwanie rozpoczęte...")
        ...
        print(f"Błąd w listen_for_tokens: {e}")
